...
const exampleScene = ( scale ) => {
  ...
  testSceneEncoding.append( testIntermediateEncoding, new Affine( scale, 0, 0, scale, 0, 0 ) );
  ...
  testSceneEncoding.finalize_scene();

  // TODO: scaling based on devicePixelRatio
  return new SceneFrame( [ sceneEncoding, testSceneEncoding ], () => {
    sceneEncoding.free();
  } )
};
